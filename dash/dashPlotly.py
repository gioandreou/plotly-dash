...
app.layout = html.Div([
    ...
    dcc.Graph(id='scatterplot2',
                        figure={'data':[
                            go.Scatter(x=random_x,y=random_y,mode='markers',
                            marker = {'size':12,'color': 'rgb(142,24,13)','symbol':'pentagon','line':{'width':2}}
                            )],
                            'layout':go.Layout(title='My scatterplot',
                                                xaxis= {'title':'some x title'})}
),
    dcc.Graph(id='scatterplot3',
                        figure={'data':[
                            go.Scatter(x=random_x,y=random_y,mode='markers',
                            marker = {'size':12,'color': 'rgb(91,104,13)','symbol':'pentagon','line':{'width':2}}
                            )],
                            'layout':go.Layout(title='My scata',
                                                xaxis= {'title':'some x title'})}
)])
